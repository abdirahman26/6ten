      ...
      <div className="container mx-auto p-4 max-w-6xl">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
          <div className="md:w-1/3 text-center md:text-left">
            ...
            <div className="flex items-center mt-8 text-[var(--textSecondary)]">
              <div></div>
            </div>
            <div className="flex items-center mt-4 text-[var(--textSecondary)]">
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
            ...
            <div className="flex items-center mt-2 text-[var(--textSecondary)]">
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
