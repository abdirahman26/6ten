        ...
        <section className="py-12 px-4">
            <div className="text-center">
                ...
                <div className="max-w-3xl mx-auto space-y-6">
                    ...
                    <div className="p-6 rounded-lg shadow-lg">
                        <h3 className="text-xl font-semibold">What are your pricing plans?</h3>
                        <p className="mt-2 text-gray-700">
                    ...
                    <div className="p-6 rounded-lg shadow-lg">
                        <h3 className="text-xl font-semibold">How do you measure the success of your campaigns?</h3>
                        <p className="mt-2 text-gray-700">
                    ...
                    <div className="p-6 rounded-lg shadow-lg">
                        <h3 className="text-xl font-semibold">Can I switch services or packages later on?</h3>
                        <p className="mt-2 text-gray-700">
